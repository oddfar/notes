...
![image-20210331153042083](https://gcore.jsdelivr.net/gh/oddfar/static/img/JavaSE-集合.assets/image-20210331153042083.png)
...
![image-20210331153544575](https://gcore.jsdelivr.net/gh/oddfar/static/img/JavaSE-集合.assets/image-20210331153544575.png)
...
![image-20210331154056812](https://gcore.jsdelivr.net/gh/oddfar/static/img/JavaSE-集合.assets/image-20210331154056812.png)
...
![image-20210331154430064](https://gcore.jsdelivr.net/gh/oddfar/static/img/JavaSE-集合.assets/image-20210331154430064.png)
...
![image-20210331160154030](https://gcore.jsdelivr.net/gh/oddfar/static/img/JavaSE-集合.assets/image-20210331160154030.png)

上图很形象的展示了HashMap的数据结构（数组+链表+红黑树），桶中的结构可能是链表，也可能是红黑树，红黑树的引入是为了提高效率。

![hashMap内存结构图](https://gcore.jsdelivr.net/gh/oddfar/static/img/JavaSE-集合.assets/20181227162958496)
...
![image-20210331160910195](https://gcore.jsdelivr.net/gh/oddfar/static/img/JavaSE-集合.assets/image-20210331160910195.png)
...
![image-20210331161138894](https://gcore.jsdelivr.net/gh/oddfar/static/img/JavaSE-集合.assets/image-20210331161138894.png)
...
![image-20210331163600275](https://gcore.jsdelivr.net/gh/oddfar/static/img/JavaSE-集合.assets/image-20210331163600275.png)
