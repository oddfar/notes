...
![image-20210329172035497](https://gcore.jsdelivr.net/gh/oddfar/static/img/JavaSE-常用类.assets/image-20210329172035497.png)
...
![image-20210329221102470](https://gcore.jsdelivr.net/gh/oddfar/static/img/JavaSE-常用类.assets/image-20210329221102470.png)
...
![image-20210329220750868](https://gcore.jsdelivr.net/gh/oddfar/static/img/JavaSE-常用类.assets/image-20210329220750868-1617026885587.png)
...
![image-20210329225829453](https://gcore.jsdelivr.net/gh/oddfar/static/img/JavaSE-常用类.assets/image-20210329225829453.png)

方法中的异常：

![image-20210329225858173](https://gcore.jsdelivr.net/gh/oddfar/static/img/JavaSE-常用类.assets/image-20210329225858173.png)
...
![image-20210330110521687](https://gcore.jsdelivr.net/gh/oddfar/static/img/JavaSE-常用类.assets/image-20210330110521687.png)

可能这里还是不够明显，构造方法实例化方式的内存图：String str = new String("Hello");

![image-20210330110555759](https://gcore.jsdelivr.net/gh/oddfar/static/img/JavaSE-常用类.assets/image-20210330110555759.png)

当我们再一次的new一个String对象时：

![image-20210330110629270](https://gcore.jsdelivr.net/gh/oddfar/static/img/JavaSE-常用类.assets/image-20210330110629270.png)
...
![image-20210330111048863](https://gcore.jsdelivr.net/gh/oddfar/static/img/JavaSE-常用类.assets/image-20210330111048863.png)

### 3、String常用的方法

![image-20210330111326341](https://gcore.jsdelivr.net/gh/oddfar/static/img/JavaSE-常用类.assets/image-20210330111326341.png)
...
![image-20210330112025681](https://gcore.jsdelivr.net/gh/oddfar/static/img/JavaSE-常用类.assets/image-20210330112025681.png)
...
![image-20210330113151662](https://gcore.jsdelivr.net/gh/oddfar/static/img/JavaSE-常用类.assets/image-20210330113151662.png)
