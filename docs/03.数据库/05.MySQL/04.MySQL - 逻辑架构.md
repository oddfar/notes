...
![img](https://testingcf.jsdelivr.net/gh/oddfar/static/img/MySQL高级.assets/540235-20160927083854563-2139392246.jpg)
...
![image-20210520161848827](https://testingcf.jsdelivr.net/gh/oddfar/static/img/MySQL高级.assets/image-20210520161848827.png)

真正执行的顺序：

​		随着 Mysql 版本的更新换代，其优化器也在不断的升级，优化器会分析不同执行顺序产生的性能消耗不同而动 态调整执行顺序。下面是经常出现的查询顺序：

![image-20210520161931864](https://testingcf.jsdelivr.net/gh/oddfar/static/img/MySQL高级.assets/image-20210520161931864.png)

![image-20210520164022838](https://testingcf.jsdelivr.net/gh/oddfar/static/img/MySQL高级.assets/image-20210520164022838.png)
...
![1551186043529](https://testingcf.jsdelivr.net/gh/oddfar/static/img/MySQL高级.assets/1551186043529.png)
...
![1556086372754](https://testingcf.jsdelivr.net/gh/oddfar/static/img/MySQL高级.assets/1556086372754.png)
...
- 事务控制
  ...
  **
  ...
  ![1556075130115](https://testingcf.jsdelivr.net/gh/oddfar/static/img/MySQL高级.assets/1556075130115.png)
...
- 外键约束
  ...
  ![1556087540767](https://testingcf.jsdelivr.net/gh/oddfar/static/img/MySQL高级.assets/1556087540767.png)
  ...
  ![1556087611295](https://testingcf.jsdelivr.net/gh/oddfar/static/img/MySQL高级.assets/1556087611295.png)

  删除 country_id为 1 的 country 数据，有外键时会删除失败

  ![1556087719145](https://testingcf.jsdelivr.net/gh/oddfar/static/img/MySQL高级.assets/1556087719145.png)
  ...
  ![1556087759615](https://testingcf.jsdelivr.net/gh/oddfar/static/img/MySQL高级.assets/1556087759615.png)

  更新后， 子表的数据信息为 ：

  ![1556087793738](https://testingcf.jsdelivr.net/gh/oddfar/static/img/MySQL高级.assets/1556087793738.png)
...
- **存储方式**	
  ...
  ![1556075336630](https://testingcf.jsdelivr.net/gh/oddfar/static/img/MySQL高级.assets/1556075336630.png)
...
- 不支持事务
  ...
  ![1551347590309](https://testingcf.jsdelivr.net/gh/oddfar/static/img/MySQL高级.assets/1551347590309.png)
...
- 文件存储方式
  ...
  ![1556075073836](https://testingcf.jsdelivr.net/gh/oddfar/static/img/MySQL高级.assets/1556075073836.png)
...
![1556076359503](https://testingcf.jsdelivr.net/gh/oddfar/static/img/MySQL高级.assets/1556076359503.png)
...
![1551408083254](https://testingcf.jsdelivr.net/gh/oddfar/static/img/MySQL高级.assets/1551408083254.png)

order_1991中的数据 ： 

![1551408133323](https://testingcf.jsdelivr.net/gh/oddfar/static/img/MySQL高级.assets/1551408133323.png)

order_all中的数据 ：

![1551408216185](https://testingcf.jsdelivr.net/gh/oddfar/static/img/MySQL高级.assets/1551408216185.png)
...
![1551408519889](https://testingcf.jsdelivr.net/gh/oddfar/static/img/MySQL高级.assets/1551408519889.png)
...
![image-20210520162731111](https://testingcf.jsdelivr.net/gh/oddfar/static/img/MySQL高级.assets/image-20210520162731111.png)
