...
![image-20210607170919526](https://gcore.jsdelivr.net/gh/oddfar/static/img/ElasticSearch/image-20210607170919526.png)
...
![38、ElasticSearch-00000001](https://gcore.jsdelivr.net/gh/oddfar/static/img/ElasticSearch/38、ElasticSearch-00000001.png)

一位名叫 **Doug Cutting **的美国工程师，也迷上了搜索引擎。他做了一个用于文本搜索的函数库（姑且理解为软件的功能组件），命名为 **Lucene**。

![38、ElasticSearch-00000002](https://gcore.jsdelivr.net/gh/oddfar/static/img/ElasticSearch/38、ElasticSearch-00000002.png)
...
![38、ElasticSearch-00000003](https://gcore.jsdelivr.net/gh/oddfar/static/img/ElasticSearch/38、ElasticSearch-00000003.png)

2004年，Doug Cutting再接再励，在Lucene的基础上，和Apache开源伙伴 Mike Cafarella 合作，开发了一款可以代替当时的主流搜索的开源搜索引擎，命名为 **Nutch** 。

![38、ElasticSearch-00000004](https://gcore.jsdelivr.net/gh/oddfar/static/img/ElasticSearch/38、ElasticSearch-00000004.png)
...
![38、ElasticSearch-00000005](https://gcore.jsdelivr.net/gh/oddfar/static/img/ElasticSearch/38、ElasticSearch-00000005.png)
...
![38、ElasticSearch-00000006](https://gcore.jsdelivr.net/gh/oddfar/static/img/ElasticSearch/38、ElasticSearch-00000006.png)

还是2004年，Google又发表了一篇技术学术论文，介绍自己的MapReduce编程模型。这个编程模型， 用于大规模数据集（大于1TB）的并行分析运算。

第二年（2005年），Doug Cutting又基于MapReduce，在Nutch搜索引擎实现了该功能。

![38、ElasticSearch-00000007](https://gcore.jsdelivr.net/gh/oddfar/static/img/ElasticSearch/38、ElasticSearch-00000007.png)

2006年，Yahoo（雅虎）公司，招安了Doug Cutting

![38、ElasticSearch-00000008](https://gcore.jsdelivr.net/gh/oddfar/static/img/ElasticSearch/38、ElasticSearch-00000008.png)
...
![38、ElasticSearch-00000009](https://gcore.jsdelivr.net/gh/oddfar/static/img/ElasticSearch/38、ElasticSearch-00000009.png)

Hadoop这个名字，实际上是Doug Cutting他儿子的黄色玩具大象的名字。所以，Hadoop的Logo，就是一只奔跑的黄色大象。

![38、ElasticSearch-00000010](https://gcore.jsdelivr.net/gh/oddfar/static/img/ElasticSearch/38、ElasticSearch-00000010.png)
...
![38、ElasticSearch-00000011](https://gcore.jsdelivr.net/gh/oddfar/static/img/ElasticSearch/38、ElasticSearch-00000011.png)

好吧，反正就是紧跟Google时代步伐，你出什么，我学什么。

所以，Hadoop的核心部分，基本上都有Google的影子。

![38、ElasticSearch-00000012](https://gcore.jsdelivr.net/gh/oddfar/static/img/ElasticSearch/38、ElasticSearch-00000012.png)
...
![38、ElasticSearch-00000013](https://gcore.jsdelivr.net/gh/oddfar/static/img/ElasticSearch/38、ElasticSearch-00000013.png)

![38、ElasticSearch-00000014](https://gcore.jsdelivr.net/gh/oddfar/static/img/ElasticSearch/38、ElasticSearch-00000014.png)

![38、ElasticSearch-00000015](https://gcore.jsdelivr.net/gh/oddfar/static/img/ElasticSearch/38、ElasticSearch-00000015.png)

![38、ElasticSearch-00000015](https://gcore.jsdelivr.net/gh/oddfar/static/img/ElasticSearch/38、ElasticSearch-00000015-1623059278022.png)

![38、ElasticSearch-00000016](https://gcore.jsdelivr.net/gh/oddfar/static/img/ElasticSearch/38、ElasticSearch-00000016.png)
...
![img](https://gcore.jsdelivr.net/gh/oddfar/static/img/ElasticSearch/es-introduce-1-3.png)

和 mysql 的类比

![image-20210620225735121](https://gcore.jsdelivr.net/gh/oddfar/static/img/ElasticSearch/image-20210620225735121.png)
