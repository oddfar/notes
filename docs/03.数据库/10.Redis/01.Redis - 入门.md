...
- redis客户端连接
  ...
  ![image](https://gcore.jsdelivr.net/gh/oddfar/static/img/Redis.assets/image-20210407105934960.png)
...
- 执行ping、get和set操作、退出
  ...
  ![image-20210407001739971](https://gcore.jsdelivr.net/gh/oddfar/static/img/Redis.assets/image-20210407001739971.png)
