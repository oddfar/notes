...
7. 查看默认安装目录：`cd /usr/local/bin`
   ...
   ![image-20210406233231151](https://testingcf.jsdelivr.net/gh/oddfar/static/img/Redis.assets/image-20210406233231151.png)
...
8. redis默认不是后台启动，修改文件
   ...
   ![image-20210406234601005](https://testingcf.jsdelivr.net/gh/oddfar/static/img/Redis.assets/image-20210406234601005.png)
...
- redis客户端连接
  ...
  ![image](https://testingcf.jsdelivr.net/gh/oddfar/static/img/Redis.assets/image-20210407105934960.png)
...
- 执行ping、get和set操作、退出
  ...
  ![image-20210407001739971](https://testingcf.jsdelivr.net/gh/oddfar/static/img/Redis.assets/image-20210407001739971.png)
